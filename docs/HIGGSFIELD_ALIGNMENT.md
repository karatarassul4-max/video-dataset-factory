...
For the strongest version of the experiment, enable `ocr.provider: easyocr` and `aesthetic.provider: laion`, then report manual precision for rejected watermark/text clips and low-aesthetic clips.
